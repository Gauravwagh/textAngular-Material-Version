! function(a, b) {
    b["true"] = a, window.rangy = function() {
        function a(a, b) {
            var c = typeof a[b];
        ...
        function D(a) {
            a.START_TO_START = aa, a.START_TO_END = ba, a.END_TO_END = ca, a.END_TO_START = da, a.NODE_BEFORE = ea, a.NODE_AFTER = fa, a.NODE_BEFORE_AND_AFTER = ga, a.NODE_INSIDE = ha
        }
        ...
        C.prototype = {
            ...
            compareBoundaryPoints: function(a, b) {
                ...
                var c, d, e, f, g = a == da || a == aa ? "start" : "end",
                    h = a == ba || a == aa ? "start" : "end";
            ...
            compareNode: function(a) {
                ...
                return 0 > d ? e > 0 ? ga : ea : e > 0 ? fa : ha
            },
            ...
            containsNode: function(a, b) {
                return b ? this.intersectsNode(a, !1) : this.compareNode(a) == ha
            },
        ...
        function m(b) {
            if (b._ranges.length = 0, "None" == b.docSelection.type) g(b);
                ...
                if (k(c)) l(b, c);
                    ...
                    for (var d, f = w.getDocument(c.item(0)), h = 0; h < b.rangeCount; ++h) d = a.createRange(f),
                        d.selectNode(c.item(h)), b._ranges.push(d);
    ...
    b["true"] = a,
        function(a, b) {
            ...
            var l = b.$$minErr("$sanitize"),
                ...
                y = e("rp,rt"),
                z = b.extend({}, y, x),
                A = b.extend({}, x, e("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h4,h5,h6,ol,preul")),
    ...
    function() {
        ...
        var e = /^(address|article|aside|audio|blockquote|canvas|dd|div|dl|fieldset|figcaption|figure|footer|form|h1|h2|h4|h5|h6|p|pre|ul)$/i,
            f = /^(ul|li|ol)$/i,
            g = /^(address|article|aside|audio|blockquote|canvas|dd|div|dl|fieldset|figcaption|figure|footer|form|h1|h2|h4|h5|h6|ol|p|pre|ul|li)$/i;
        ...
        if (c.ie > 8 || void 0 === c.ie) {
            ...
            h || (h = function() {
                ...
                var c = m(b, a.cssRules || a.rules);
                a.removeRule ? a.removeRule(c) : a.deleteRule(c)
            }
        }
        angular.module("textAngular.factories", []).factory("taBrowserTag", [function() {
            ...
            return {
                ...
                link: function(l, u, v, w) {
                    var x, y, z, A, B = void 0 !== u.attr("contenteditable") && u.attr("contenteditable"),
                        C = B || "textarea" === u[0].tagName.toLowerCase() || "input" === u[0].tagName.toLowerCase(),
                        D = !1,
                        E = !1,
                        F = !1,
                        G = v.taUnsafeSanitizer || q.disableSanitizer,
                        H = /^(9|19|20|27|33|34|35|36|37|38|39|40|45|112|113|114|115|116|117|118|119|120|121|122|123|144|145)$/i,
                        I = /^(8|13|32|46|59|61|107|109|186|187|188|189|190|191|192|219|220|221|222)$/i;
                            ...
                            if (0 === b.children().length) a = "<" + v.taDefaultWrap + ">" + a + "</" + v.taDefaultWrap + ">";
                                ...
                                if (f)
                                    for (a = "", c = 0; c < d.length; c++)
                                        if (d[c].nodeName.toLowerCase().match(e)) a += d[c].outerHTML;
                                        else {
                    ...
                    var L;
                    l["$undoManager" + (v.id || "")] = w.$undoManager = {
                        _stack: [],
                        _index: 0,
                        _max: 1e3,
                        push: function(a) {
                            return "undefined" == typeof a || null === a || "undefined" != typeof this.current() && null !== this.current() && a === this.current() ? a : (this._index < this._stack.length - 1 && (this._stack = this._stack.slice(0, this._index + 1)), this._stack.push(a), L && b.cancel(L), this._stack.length > this._max && this._stack.shift(), this._index = this._stack.length - 1, a)
                        },
                        undo: function() {
                    ...
                    var M = l["$undoTaBind" + (v.id || "")] = function() {
                            if (!D && B) {
                                var a = w.$undoManager.undo();
                                "undefined" != typeof a && null !== a && ($(a), P(a, !1), m.setSelectionToElementEnd(u[0].childNodes.length ? u[0].childNodes[u[0].childNodes.length - 1] : u[0]))
                            }
                        },
                        N = l["$redoTaBind" + (v.id || "")] = function() {
                            if (!D && B) {
                                var a = w.$undoManager.redo();
                                "undefined" != typeof a && null !== a && ($(a), P(a, !1), m.setSelectionToElementEnd(u[0].childNodes.length ? u[0].childNodes[u[0].childNodes.length - 1] : u[0]))
                            }
                        },
                        O = function() {
                            if (B) return u[0].innerHTML;
                            if (C) return u.val();
                            throw "textAngular Error: attempting to update non-editable taBind"
                        },
                        P = function(a, b) {
                            F = !0, ("undefined" == typeof b || null === b) && (b = !0 && B), ("undefined" == typeof a || null === a) && (a = O()), J(a) ? ("" !== w.$viewValue && w.$setViewValue(""), b && "" !== w.$undoManager.current() && w.$undoManager.push("")) : (Z(), w.$viewValue !== a && (w.$setViewValue(a), b && w.$undoManager.push(a)))
                        };
                    l["updateTaBind" + (v.id || "")] = function() {
                        D || P()
                    };
                    var Q = function(b) {
                            return w.$oldViewValue = a(k(b), w.$oldViewValue, G)
                        },
                        R = function(a) {
                            return v.required && w.$setValidity("required", !J(a)), a
                        };
                    if (w.$parsers.push(Q), w.$parsers.unshift(K), w.$parsers.unshift(R), w.$formatters.push(Q), w.$formatters.unshift(K), w.$formatters.unshift(R), w.$formatters.unshift(function(a) {
                            return w.$undoManager.push(a || "")
                        }), C)
                        if (l.events = {}, B) {
                            var S = !1,
                                T = function(c) {
                                    if (c && c.trim().length) {
                                        if (c.match(/class=["']*Mso(Normal|List)/i)) {
                                            ...
                                            if (c = c.replace(/<(|\/)meta[^>]*?>/gi, ""), c.match(/<[^>]*?(ta-bind)[^>]*?>/)) {
                                                if (c.match(/<[^>]*?(text-angular)[^>]*?>/)) {
                                                    ...
                                                    for (var v = t.getByAttribute(s, "ta-bind"), x = 0; x < v.length; x++) {
                                                        for (var z = v[x][0].parentNode.parentNode, A = 0; A < v[x][0].childNodes.length; A++) z.parentNode.insertBefore(v[x][0].childNodes[A], z);
                                        ...
                                        c = a(c, "", G), /<li(\s.*)?>/i.test(c) && /(<ul(\s.*)?>|<ol(\s.*)?>).*<li(\s.*)?>/i.test(c) === !1 && (c = c.replace(/<li(\s.*)?>.*<\/li(\s.*)?>/i, "<ul>$&</ul>")), y && (c = y(l, {
                                                $html: c
                                            }) || c), m.insertHtml(c, u[0]), b(function() {
                                            w.$setViewValue(O()), S = !1, u.removeClass("processing-paste")
                                        }, 0)
                                    } else S = !1, u.removeClass("processing-paste")
                                };
                            if (u.on("paste", l.events.paste = function(a, c) {
                                    if (c && angular.extend(a, c), D || S) return a.stopPropagation(), a.preventDefault(), !1;
                                    S = !0, u.addClass("processing-paste");
                                    var d, e = (a.originalEvent || a).clipboardData;
                                    if (e && e.getData && e.types.length > 0) {
                                        for (var g = "", i = 0; i < e.types.length; i++) g += " " + e.types[i];
                                        return /text\/html/i.test(g) ? d = e.getData("text/html") : /text\/plain/i.test(g) && (d = e.getData("text/plain")), T(d), a.stopPropagation(), a.preventDefault(), !1
                                    }
                                    ...
                                    h.find("body").append(k), k[0].focus(), b(function() {
                                        f.rangy.restoreSelection(j), T(k[0].innerHTML), u[0].focus(), k.remove()
                                    }, 0)
                                }), u.on("cut", l.events.cut = function(a) {
                                    D ? a.preventDefault() : b(function() {
                                        w.$setViewValue(O())
                                    }, 0)
                                }), u.on("keydown", l.events.keydown = function(a, b) {
                                    if (b && angular.extend(a, b), !D)
                                        if (a.altKey || !a.metaKey && !a.ctrlKey) {
                                            if (13 === a.keyCode && !a.shiftKey) {
                                                ...
                                                if (/^<br(|\/)>$/i.test(d.innerHTML.trim()) && "blockquote" === d.parentNode.tagName.toLowerCase() && !d.nextSibling) {
                                                    c = angular.element(d);
                                                    var f = c.parent();
                                                    f.after(e), c.remove(), 0 === f.children().length && f.remove(), m.setSelectionToElementStart(e[0]), a.preventDefault()
                                                } else /^<[^>]+><br(|\/)><\/[^>]+>$/i.test(d.innerHTML.trim()) && "blockquote" === d.tagName.toLowerCase() && (c = angular.element(d), c.after(e), c.remove(), m.setSelectionToElementStart(e[0]), a.preventDefault())
                                            }
                                        } else 90 !== a.keyCode || a.shiftKey ? (90 === a.keyCode && a.shiftKey || 89 === a.keyCode && !a.shiftKey) && (N(), a.preventDefault()) : (M(), a.preventDefault())
                                }), u.on("keyup", l.events.keyup = function(a, c) {
                                    ...
                                    if (L && b.cancel(L), !D && !H.test(a.keyCode)) {
                                        ...
                                        var i = O();
                                        if ("" !== z && "" === i.trim()) $(z), m.setSelectionToElementStart(u.children()[0]);
                                        else if ("<" !== i.substring(0, 1) && "" !== v.taDefaultWrap) {
                                            var j = f.rangy.saveSelection();
                                            i = O(), i = "<" + v.taDefaultWrap + ">" + i + "</" + v.taDefaultWrap + ">", $(i), f.rangy.restoreSelection(j)
                                        }
                                        var k = x !== a.keyCode && I.test(a.keyCode);
                                        P(i, k), k || (L = b(function() {
                                            w.$undoManager.push(i)
                                        }, 250)), x = a.keyCode
                                    }
                                }), u.on("blur", l.events.blur = function() {
                                    E = !1, D || P(), F = !0, w.$render()
                                }), v.placeholder && (c.ie > 8 || void 0 === c.ie)) {
                                var U;
                                if (!v.id) throw "textAngular Error: An unique ID is required for placeholders to work";
                                U = i("#" + v.id + ".placeholder-text:before", 'content: "' + v.placeholder + '"'), l.$on("$destroy", function() {
                                    j(U)
                                })
                            }
                            u.on("focus", l.events.focus = function() {
                                E = !0, u.removeClass("placeholder-text")
                            ...
                            var V = function(a, b) {
                                ...
                                W = function(a, b) {
                                    var c = "",
                                        d = a.childNodes;
                                    b++, c += V("	", b - 1) + a.outerHTML.substring(0, a.outerHTML.indexOf("<li"));
                                    for (var e = 0; e < d.length; e++) d[e].outerHTML && (c += "ul" === d[e].nodeName.toLowerCase() || "ol" === d[e].nodeName.toLowerCase() ? "\n" + W(d[e], b) : "\n" + V("	", b) + d[e].outerHTML);
                                    return c += "\n" + V("	", b - 1) + a.outerHTML.substring(a.outerHTML.lastIndexOf("<"))
                                };
                            w.$formatters.unshift(function(a) {
                                var b = angular.element("<div>" + a + "</div>")[0].childNodes;
                                if (b.length > 0) {
                                    a = "";
                                    for (var c = 0; c < b.length; c++) b[c].outerHTML && (a.length > 0 && (a += "\n"), a += "ul" === b[c].nodeName.toLowerCase() || "ol" === b[c].nodeName.toLowerCase() ? "" + W(b[c], 0) : "" + b[c].outerHTML)
                                }
                                return a
                            })
                        }
                    var X = function(a) {
                        ...
                        Y = function(a, c) {
                            if (c && angular.extend(a, c), !p && !D) {
                                p = !0;
                                var d;
                                d = a.originalEvent ? a.originalEvent.dataTransfer : a.dataTransfer, l.$emit("ta-drop-event", this, a, d), b(function() {
                                    p = !1, P()
                                }, 100)
                            }
                        },
                        Z = l["reApplyOnSelectorHandlers" + (v.id || "")] = function() {
                            D || angular.forEach(n, function(a) {
                                u.find(a).off("click", X).on("click", X)
                            })
                        },
                        $ = function(a) {
                            u[0].innerHTML = a
                    ...
                    w.$render = function() {
                        var a = w.$viewValue || "";
                        F || (B && E && (u.removeClass("placeholder-text"), u[0].blur(), b(function() {
                            u[0].focus(), m.setSelectionToElementEnd(u.children()[u.children().length - 1])
                        }, 1)), B ? ($(v.placeholder ? "" === a ? z : a : "" === a ? z : a), D ? u.off("drop", Y) : (Z(), u.on("drop", Y))) : "textarea" !== u[0].tagName.toLowerCase() && "input" !== u[0].tagName.toLowerCase() ? $(o(a)) : u.val(a)), B && v.placeholder && ("" === a ? E ? u.removeClass("placeholder-text") : u.addClass("placeholder-text") : u.removeClass("placeholder-text")), F = !1
                    }, v.taReadonly && (D = l.$eval(v.taReadonly), D ? (u.addClass("ta-readonly"), ("textarea" === u[0].tagName.toLowerCase() || "input" === u[0].tagName.toLowerCase()) && u.attr("disabled", "disabled"), void 0 !== u.attr("contenteditable") && u.attr("contenteditable") && u.removeAttr("contenteditable")) : (u.removeClass("ta-readonly"), "textarea" === u[0].tagName.toLowerCase() || "input" === u[0].tagName.toLowerCase() ? u.removeAttr("disabled") : B && u.attr("contenteditable", "true")), l.$watch(v.taReadonly, function(a, b) {
                        b !== a && (a ? (u.addClass("ta-readonly"), ("textarea" === u[0].tagName.toLowerCase() || "input" === u[0].tagName.toLowerCase()) && u.attr("disabled", "disabled"), void 0 !== u.attr("contenteditable") && u.attr("contenteditable") && u.removeAttr("contenteditable"), angular.forEach(n, function(a) {
                            u.find(a).on("click", X)
                        }), u.off("drop", Y)) : (u.removeClass("ta-readonly"), "textarea" === u[0].tagName.toLowerCase() || "input" === u[0].tagName.toLowerCase() ? u.removeAttr("disabled") : B && u.attr("contenteditable", "true"), angular.forEach(n, function(a) {
                            u.find(a).off("click", X)
                        }), u.on("drop", Y)), D = a)
                    })), B && !D && (angular.forEach(n, function(a) {
                        u.find(a).on("click", X)
                    }), u.on("drop", Y), u.on("blur", function() {
                        c.webkit && (d = !0)
                    }))
                }
            }
                ...
                link: function(m, n, o, p) {
                    ...
                    y = e(o.taDefaultWrap), angular.extend(m, angular.copy(c), {
                        wrapSelection: function(a, b, c) {
                            "undo" === a.toLowerCase() ? m["$undoTaBindtaTextElement" + B]() : "redo" === a.toLowerCase() ? m["$redoTaBindtaTextElement" + B]() : (y(a, !1, b), c && m["reApplyOnSelectorHandlerstaTextElement" + B](), m.displayElements.text[0].focus())
                        },
                        ...
                        scrollWindow: angular.element("<md-whiteframe class='ta-scroll-window md-whiteframe-z1' layout-padding></md-whiteframe>"),
                        ...
                        }, m.displayElements.resize.anchors[3].on("mousedown", z), m.reflowResizeOverlay(a), C(b, "click", function() {
                            m.hideResizeOverlay()
                        })
                    ...
                    if (m.startAction = function() {
                            return m._actionRunning = !0, D = g.rangy.saveSelection(),
                                function() {
                                    D && g.rangy.restoreSelection(D)
                                }
                        }, m.endAction = function() {
                            m._actionRunning = !1, D && g.rangy.removeMarkers(D), D = !1, m.updateSelectedStyles(), m.showHtml || m["updateTaBindtaTextElement" + B]()
                        }, u = function() {
                        ...
                        p.$parsers.push(F), p.$formatters.push(F)
    ...
    toolbar: [
        ["h1", "h2", "h4", "p", "pre", "quote", "bold", "italics", "underline", "ul", "ol"]
    ],
    classes: {
        focussed: "focussed",
        toolbar: "btn-toolbar",
        toolbarButton: "btn md-raised md-primary md-button md-default-theme toolbar-button",
    ...
    angular.forEach(["h1", "h2", "h4", "h5", "h6"], function(b) {
        a(b.toLowerCase(), {
